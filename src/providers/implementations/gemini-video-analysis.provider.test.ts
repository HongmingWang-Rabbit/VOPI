...
import { GeminiVideoAnalysisProvider } from './gemini-video-analysis.provider.js';

describe('GeminiVideoAnalysisProvider', () => {
  let provider: GeminiVideoAnalysisProvider;
  ...
  beforeEach(() => {
    provider = new GeminiVideoAnalysisProvider();
    vi.clearAllMocks();
  ...
  describe('providerId', () => {
    it('should have correct provider ID', () => {
      expect(provider.providerId).toBe('gemini-video');
    });
  });
  ...
  describe('analyzeVideo', () => {
    ...
    it('should throw on invalid JSON response', async () => {
      ...
      ).rejects.toThrow('Failed to parse video analysis response');
    });
